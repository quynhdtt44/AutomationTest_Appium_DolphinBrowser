...
public class JsonHelper {
    public static String readValueJsonObject(String filePath, String keyName) {
...
//        try {
//
//            reader = Files.newBufferedReader(Paths.get(SystemsHelper.getCurrentDirDataJson() + filePath));
//
//            Gson gson = new Gson();
//            //Convert Json file to Json Object
//            JsonObject jsonObject = gson.fromJson(reader, JsonObject.class);
...
//
//            //Store new Json data to new file
//            File jsonFile = new File(SystemsHelper.getCurrentDirDataJson() + newFilePath);
//            OutputStream outputStream = new FileOutputStream(jsonFile);
//            outputStream.write(gson.toJson(jsonObject).getBytes());
//            outputStream.flush();
//
